...
//
// ── VÌ SAO CẦN FLOW NÀY (khác hẳn API key trước đây) ───────────────────────
...
object TtsServiceAccountAuth {
        ...
        return try {
            ...
            Log.d(
                ...
                "loadServiceAccount: không đọc được assets/$ASSET_FILE_NAME, " +
                        "coi như chưa cấu hình remote source (pregen/ vẫn hoạt động bình thường)",
                e
            )
            null
        }
    ...
    // gọi đúng 1 endpoint này, cùng phong cách TtsGoogleDriveSource.kt.
