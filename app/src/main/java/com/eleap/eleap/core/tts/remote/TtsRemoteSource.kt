...
// 1 CDN riêng, hay bất kỳ nguồn nào khác. Cùng tinh thần với TtsEngine.kt
// (interface chung cho AndroidTtsEngine/KokoroTtsEngine) — thêm 1 nguồn mới
// sau này chỉ cần viết 1 class implement interface này, không đụng gì tới
// Downloader hay bất kỳ nơi nào khác.
//
